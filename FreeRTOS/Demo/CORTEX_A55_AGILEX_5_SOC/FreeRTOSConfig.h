...
#define INCLUDE_eTaskGetState                   1 // For Full Demo.
#define INCLUDE_xTimerPendFunctionCall          1
#define INCLUDE_xTaskAbortDelay                 1
#define INCLUDE_xTaskGetHandle                  1
#define INCLUDE_xTaskResumeFromISR              1
#define INCLUDE_xQueueGetMutexHolder            1 // For Full Demo.
...
#define configINTERRUPT_CONTROLLER_BASE_ADDRESS               0X1D000000U
#define configINTERRUPT_CONTROLLER_CPU_INTERFACE_OFFSET       0x1000
#define configUNIQUE_INTERRUPT_PRIORITIES                     16// Ignitarium: Refer GIC600 TRM - Implementation-defined features reference - Interrupt prioritization
                                                                // The system supports 32 levels of interrupt priority, but since we are running
                                                                // in non secure mode we only get half that
...
#define configDEMO_CLI                     0
#define configDEMO_DRIVER_SAMPLES          1
#define configDEMO_DRIVER_TESTS            2
#define configDEMO_BLINKY                  3
#define configDEMO_FULLTEST                4
#define configDEMO_ENET                    5
#define configDEMO_HELLO_WORLD             6

#ifndef configACTIVE_DEMO
#define configACTIVE_DEMO configDEMO_CLI
#endif

/* Definition for FreeRTOS tests. */
#if configACTIVE_DEMO == configDEMO_FULLTEST
