 ...
 *
 * Header file for helper module to read RBF file from storage 
 */


#ifndef _SOCFPGA_MMC_H_
#define _SOCFPGA_MMC_H_
 ...
 */
uint8_t* mmc_read_rbf(media_source_t media_src, const char *pcFileName, uint32_t *file_size);

#endif /*_SOCFPGA_MMC_H_ */
